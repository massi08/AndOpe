...
<head>
  ...
  <link href="<c:url value = "/css/manage_project.css" />" type="text/css" rel="stylesheet"/>
    ...
    <div class="cards defaut-color">
      <div class="card col s4 sticky-action">
        ...
        <div class="card-content">
          <span class="card-title activator grey-text text-darken-4">VueJs<i
               class="material-icons right">more_vert</i></span>
        </div>

        <div class="card-action">
          <a href="./cours.jsp">Cours</a>
          <a href="./exercices.jsp">Exercices</a>
        </div>

        <div class="card-reveal">
          <span class="card-title grey-text text-darken-4">VueJs<i class="material-icons right">close</i></span>
          <p>Vue est un framework évolutif pour construire des interfaces
